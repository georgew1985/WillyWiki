...
Before starting developing for Willy, be aware of the infrastructure used to setup the system.
...
A valid Willy component needs the following Prerequisites: +
...
3. Clone the repository you just created
...
8. Add a .travis.yml CI file
9. Add a docker-compose.build.yml file
10. Add a docker-compose.yml file
11. Add a folder with the name "docker"
12. Add a file with the name "Dockerfile"
13. Commit the changes
14. Push to github
15. Create a pull request on the component master	
