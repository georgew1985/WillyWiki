...
1. Choose a component to extend development on, or create a new component

1.1 Requirements for willy components

	- Always a dockercompose
	- Always 1 or more services
	- Always a readme file
	- Travis file
	- Always contact a Fabian before starting
	
1.2 New component

	- Login to github windesheim-willy
	- Create a new component repository on Windesheim-Willy/your-component-lowercase-with-lines-as-seperator
	- Clone the master repository
	- Create a new branch "git checkout -b feature/init-component"
	- Go to your repository directory
	- Add a README.md file
	- Add a .travis.yml CI file
