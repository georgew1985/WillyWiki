...
Willy is based on various ROS nodes, called components. Before starting developing for Willy be aware of the infrastructure used to setup the system. +
There are basically two forms of developing new features for Willy: +

- Create a new Willy component
- Extend an exisiting Willy component 

==== Willy component development

To be able to develop Willy components and make them available within Willy, there are a few Prerequisites: +

- A dockercompose file within the component directory +
- One or more services pointed +
- A readme file filled with at least a description +
- A Travis file to provide the input for the CI +


===== New Willy component

1. Login on '*https://github.com/Windesheim-Willy*'
2. Create a new component repository on '*Windesheim-Willy/your-component-lowercase-with-lines-as-seperator*'
3. Clone the master repository
4. Create a new branch "git checkout -b feature/init-component"
5. Go to your repository directory
6. Add a README.md file
7. Add a .travis.yml CI file
