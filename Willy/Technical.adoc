...
(Systeem Dossier,
2016)image:../Archive/2018-1/Research/media/current-status/image4.jpeg[image,width=112,height=149]
...
image:../Archive/2018-1/Research/media/current-status/image5.jpg[image,width=604,height=427]
