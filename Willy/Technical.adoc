...
==== Components
This chapter contains all the components with information.
...
(Systeem Dossier,
2016)image:../Archive/2018-1/Research/media/current-status/image4.jpeg[image]
...
image:../Archive/2018-1/Research/media/current-status/image5.jpg[image]
...
image:../Archive/2018-1/Research/media/current-status/image6.jpeg[image]
image:../Archive/2018-1/Research/media/current-status/image7.png[image]
...
that sound.image:../Archive/2018-1/Research/media/current-status/image8.jpeg[image]
...
image:../Archive/2018-1/Research/media/current-status/image9.jpg[image](!!!OLD!!!)
...
image:../Archive/2018-1/Research/media/current-status/image10_3.jpg[image]
...
image:../Archive/2018-1/Research/media/current-status/image12.jpg[image]
...
image:../Archive/2018-1/Research/media/current-status/image13.jpeg[image]

The current state of Willy has no LIDAR installed. The previous group has 
done some research concerning LIDAR and the link to ROS. But came to the 
conclusion that it is not possible to create a link between LIDAR and ROS. 
Therefore they decided to not implement the LIDAR sensor.
...
===== Kinect
image:../Archive/2018-1/Research/media/current-status/image11.png[image]
