...
IMPORTANT: The current screen is a replacement of the old screen. This 
...
- [[[pp]]] HCSR04 Datasheet version 1. Retrieved from https://www.electroschematics.com/wp-content/uploads/2013/07/HCSR04-datasheet-version-1.pdf
