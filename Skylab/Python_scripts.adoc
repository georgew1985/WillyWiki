...
|Skylab_app_get_status_0.py|Skylab|Fetch every 10 seconds the location that was called by a user from the App site|
|Skylab_app_post_status_0.py|Skylab|Post status from Willy activity topic and classroom location to App website every 10 seconds|
