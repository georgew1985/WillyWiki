...
link:Troubleshooting/index.adoc[Troubleshouting]::
        - link:Troubleshooting/Known-bugs.adoc[Known Bugs]

link:Research/index.adoc[Research]::
	- link:Research/Social-interaction.adoc[Social interaction]
	- link:Research/Hardware.adoc[Hardware]
	- link:Research/Peripherals.adoc[Peripherals]
