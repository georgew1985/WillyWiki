...
link:{url}/hardware_nodes/index.html[Hardware nodes]::
        - link:{url}/hardware_nodes/Nodes_and_topics.html[brain node]
        - link:{url}/hardware_nodes/Nodes_and_topics.html[sensor node]
        - link:{url}/hardware_nodes/Nodes_and_topics.html[si node]
        - link:{url}/hardware_nodes/Nodes_and_topics.html[power node]
        - link:{url}/hardware_nodes/Nodes_and_topics.html[willyWRT]
