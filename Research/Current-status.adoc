...
image:media/image2.jpeg[image,width=163,height=96]
...
image:media/image3.jpeg[image,width=155,height=116]Motor controller
-------------------------------------------------------------------
...
(Systeem Dossier,
2016)image:media/image4.jpeg[image,width=112,height=149]
...
image:media/image5.jpg[image,width=604,height=427]
...
image:media/image6.jpeg[image,width=268,height=358]image:media/image7.png[image,width=269,height=359]
...
that sound.image:media/image8.jpeg[image,width=208,height=117]
...
image:media/image9.jpg[image,width=604,height=427]
...
image:media/image10.jpg[image,width=339,height=476]

1.  image:media/image11.png[image,width=266,height=92]Kinect sensor
...
image:media/image12.jpg[image,width=604,height=427]
...
image:media/image13.jpeg[image,width=130,height=174]The current state of
...
11.1 Current installed packages
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Install Ross +
_sudo sh -c 'echo "deb http://packages.ros.org/ros/ubuntu $(lsb_release
-sc) main" > /etc/apt/sources.list.d/ros-latest.list'_

_sudo apt-key adv --keyserver hkp://ha.pool.sks-keyservers.net:80
--recv-key 421C365BD9FF1F717815A3895523BAEEB01FA116_
...
_echo "source /opt/ros/lunar/setup.bash" >> ~/.bashrc +
source ~/.bashrc_
...
_sudo apt-get install Screen_ +
_sudo apt-get install ros-kinetic-rosserial +
sudo apt-get install ros-kinetic -rosserial-arduino +
sudo apt-get install ros-kinetic -rosapi +
sudo apt-get install ros-kinetic -rosbridge-server_

Give user permission to access USB ports

_sudo usermod -a -G dialout willy_
...
image:media/image15.png[Web platform,width=521,height=232]
