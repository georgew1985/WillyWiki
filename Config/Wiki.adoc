...
[CAUTION]
--
For the sidebar to scale correctly we had to manualy add the toc classes because we do not use Docbook (yet).
[source, yml]
  - sed -i 's/class="article"/class="article toc2 toc-left"/g' index.html
--
...
==== Github Pages
To do this we use Github Pages, as this is a free service and is perfect for hosting a static html site.
