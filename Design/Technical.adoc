...
The first choice we had to make with the design is which design we wanted to use. We made a design ourselves and there was a design available. The design that was available was not yet usable on the current frame the design we made is usable.
